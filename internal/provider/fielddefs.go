...
// Field describes a single form field for a provider, used by the WebUI to
...
// AuthGroup represents a set of fields for one authentication method, used by
// providers that support multiple authentication options.
type AuthGroup struct {
	Name   string  `json:"name"`
	Fields []Field `json:"fields"`
}

// Definition describes a provider's form fields for the WebUI.
...
// Definitions maps provider IDs to their form field definitions.
//
//nolint:gochecknoglobals // intentional package-level lookup table for the WebUI
	...
	"aliyun": {
		...
		Fields: []Field{
			...
			},
			{
				...
				Type:        "password",
				Required:    true,
				Placeholder: "Your Aliyun access secret",
			},
			{
				Name:        "region",
				Label:       "Region",
		...
		Fields: []Field{
			{
				...
				Type:        "text",
				Required:    true,
				Placeholder: "https://example.com/update?ip=%s",
				Help:        "URL template for updating DNS",
			},
			{
				Name:        "ipv4key",
				Label:       "IPv4 Key",
				Type:        "text",
				Required:    false,
				Placeholder: "Query parameter name for IPv4",
			},
			{
				Name:        "ipv6key",
				Label:       "IPv6 Key",
				Type:        "text",
				Required:    false,
				Placeholder: "Query parameter name for IPv6",
			},
			{
				Name:        "success_regex",
				Label:       "Success Regex",
				Type:        "text",
				Required:    true,
				Placeholder: "e.g. ^(ok|good)",
				Help:        "Regex pattern to match a successful response body",
			},
		},
	},
	"dd24": {
	...
	"ddnss": {
		...
		Fields: []Field{
			...
			{Name: "password", Label: "Password", Type: "password", Required: true},
			{
				...
				Type:     "boolean",
				Required: false,
				Help:     "Update both IPv4 and IPv6 simultaneously",
			},
		},
	},
	"desec": {
	...
	"dondominio": {
		...
		Fields: []Field{
			{Name: "username", Label: "Username", Type: "text", Required: true},
			{
				...
				Type:     "password",
				Required: false,
				Help:     "Deprecated, use key instead",
			},
		...
		Fields: []Field{
			{
				...
				Help:        "Get your token from duckdns.org",
			},
		},
	},
	"dyn": {
		...
		Fields: []Field{
			{Name: "username", Label: "Username", Type: "text", Required: true},
			{
				...
				Type:     "password",
				Required: false,
				Help:     "Deprecated, use client_key instead",
			},
	...
	"dynu": {
		...
		Fields: []Field{
			{Name: "username", Label: "Username", Type: "text", Required: true},
			{
				...
				Type:     "password",
				Required: true,
				Help:     "Can be plain text, MD5, or SHA256",
			},
		...
		Fields: []Field{
			{
				...
				Type:     "password",
				Required: true,
				Help:     "Enable v2 dynamic DNS at freedns.afraid.org/dynamic/v2/",
			},
		},
	},
	"gandi": {
				...
				Fields: []Field{
					{
						...
						Type:     "password",
						Required: true,
						Help:     "Deprecated, use Personal Access Token",
					},
				},
			},
		},
	...
	"gcp": {
		...
		Fields: []Field{
			...
			},
			{
				...
				Type:     "password",
				Required: true,
				Help:     "Full service account JSON credentials object",
			},
		},
	},
	"godaddy": {
		...
		Fields: []Field{
			{
				...
				Type:     "text",
				Required: true,
				Help:     "Use DynDNS credentials, not admin",
			},
			{
				Name:     "password",
				Label:    "DynDNS Password",
				Type:     "password",
				Required: true,
				Help:     "Use DynDNS credentials, not admin",
			},
	...
	"netcup": {
		...
		Fields: []Field{
			{Name: "api_key", Label: "API Key", Type: "password", Required: true},
			{
				...
				Type:     "password",
				Required: true,
				Help:     "API password, not account password",
			},
		...
		Fields: []Field{
			{
				...
				Type:     "select",
				Required: false,
				Options:  []string{"dynamic", "api"},
				Help:     "DynHost (dynamic) or ZoneDNS API (api)",
			},
		},
		AuthGroups: []AuthGroup{
			{
	...
	"variomedia": {
		...
		Fields: []Field{
			{Name: "email", Label: "Email", Type: "text", Required: true},
			{
				...
				Type:     "password",
				Required: true,
				Help:     "DNS settings password, not account password",
			},
		},
	},
	"vultr": {
